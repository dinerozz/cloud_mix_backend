...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'BotName', description: 'Name of the bot' }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, unique: true, allowNull: false }),
    __metadata("design:type", String)
], Bot.prototype, "name", void 0);
Bot = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'bots' })
], Bot);
exports.Bot = Bot;
//# sourceMappingURL=chat-bot.model.js.map